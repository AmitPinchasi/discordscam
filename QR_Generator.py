...
# Developer: Amit Pinchasi
# השתמשו בקוד רק ללמידה!
...
def main():
    print('github.com/AmitPinchasi/discordscam\n')
    print('** קיואר קוד גנרטור **')
    ...
    print('- קיואר קוד נוצר. > discord_gift.png')
    print('שלח את הקוד הזה לאחרים וחכה שיסרקו אותו באמצעות דיסקורד')
